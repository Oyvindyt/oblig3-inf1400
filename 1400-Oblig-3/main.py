...
class Game():
    ...
    def run(self):
        ...
        while self.start:
            ...
            player_sprite = pygame.transform.rotate (self.player1.image, self.player1.rotation * 180.0 / math.pi)
            self.screen.blit (player_sprite, (self.player1.position.x - player_sprite.get_rect().center[0], self.player1.position.y - player_sprite.get_rect().center[1]))
    ...
    def update(self):
        ...
        if events[pygame.K_s]:
            ...
            self.player1.shoot()
        else: self.player1.shooting = False
        ...
        # 250 er grensa
        if self.player1.velocity.length() > 250:
